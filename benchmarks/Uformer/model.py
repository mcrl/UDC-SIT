...
class Uformer(nn.Module):
    def __init__(self, img_size=256, in_chans=4, dd_in=4,
...
if __name__ == "__main__":
    ...
    model_restoration = Uformer(img_size=input_size,embed_dim=32,win_size=8,token_projection='linear',token_mlp='leff',
            depths=[1, 2, 8, 8, 2, 8, 8, 2, 1],modulator=True, dd_in=4) 
    #model_restoration= model_restoration.to('cuda')
...
#    print(model_restoration)
    # from ptflops import get_model_complexity_infomacs
    # params = get_model_complexity_info(model_restoration, (3, input_size, input_size), as_strings=True,
