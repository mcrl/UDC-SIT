...
class Options():
    ...
    def init(self, parser):        
        # global settings
        parser.add_argument('--H', type=int, default=800, help='height of input image')
        parser.add_argument('--W', type=int, default=800, help='width of input image')
        parser.add_argument('--patch_size', type=int, default=800, help='patch size of training sample') # if patch_size is 0, train with original image size
        ...
        parser.add_argument('--dataset', type=str, default ='UDC_SIT')
        ...
        parser.add_argument('--train_dir', type=str, default ='./datasets/UDC_SIT/train',  help='dir of train data')
        parser.add_argument('--val_dir', type=str, default ='./datasets/UDC_SIT/val',  help='dir of train data')
        parser.add_argument('--test_dir', type=str, default='./datasets/UDC_SIT/test', help='test_dir')
